  ...
  return (
    <div className="flex justify-center p-4">
      <div className="bg-white border rounded-sm max-w-md">
        ...
        <div className="flex flex-wrap items-center font-semibold text-sm mx-4 mt-2 mb-2">
          ...
          <div className=" w-full  mt-2">
            ...
            <div className="text-sm text-gray-400 mt-1 cursor-pointer font-medium">
          ...
          <div className="w-full mt-2">
            <textarea
              ...
              className="w-full h-9 bg-transparent border-none pt-2 rounded text-sm pl-4 text-coolGray-100"
            />
          </div>
        </div>
      </div>
